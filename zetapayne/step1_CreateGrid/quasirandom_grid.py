# Compute synthetic spectra in a quasi-random grid
# To run do: python quasirandom_grid.py <path to configuration file>
import sys, shutil
import os, time
import numpy as np
...
N_sobol = i4_sobol_generate(N_param, N_models)
print()
...
###############################################################
# For each quasi-random point create a GSSP subgrid
###############################################################
work = []
