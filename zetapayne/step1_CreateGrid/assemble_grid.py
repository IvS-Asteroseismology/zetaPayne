# This script merges all individual models of the grid into one .npz file.
# To run do: python assemble_grid.py <path to the folder with models> [N models to assemble]
import sys, gc
import os
import numpy as np
